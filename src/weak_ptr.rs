...
macro_rules! impl_weak_ptr_target {
    ($segment:expr, $name:expr, $ty:ty) => {
        unsafe impl WeakPtrTarget for $ty {
            ...
            unsafe fn __null(new: *mut c_void) {
                extern "C" {
                    #[link_name = concat!("cxxbridge2$std$weak_ptr$", $segment, "$null")]
            ...
            unsafe fn __clone(this: *const c_void, new: *mut c_void) {
                extern "C" {
                    #[link_name = concat!("cxxbridge2$std$weak_ptr$", $segment, "$clone")]
            ...
            unsafe fn __downgrade(shared: *const c_void, weak: *mut c_void) {
                extern "C" {
                    #[link_name = concat!("cxxbridge2$std$weak_ptr$", $segment, "$downgrade")]
            ...
            unsafe fn __upgrade(weak: *const c_void, shared: *mut c_void) {
                extern "C" {
                    #[link_name = concat!("cxxbridge2$std$weak_ptr$", $segment, "$upgrade")]
            ...
            unsafe fn __drop(this: *mut c_void) {
                extern "C" {
                    #[link_name = concat!("cxxbridge2$std$weak_ptr$", $segment, "$drop")]
