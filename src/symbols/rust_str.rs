...
#[export_name = "cxxbridge2$str$new"]
...
#[cfg(feature = "alloc")]
#[export_name = "cxxbridge2$str$ref"]
...
#[export_name = "cxxbridge2$str$from"]
...
#[export_name = "cxxbridge2$str$ptr"]
unsafe extern "C" fn str_ptr(this: &&str) -> *const u8 {
    this.as_ptr()
}

#[export_name = "cxxbridge2$str$len"]
