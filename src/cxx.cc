...
extern "C" {
void cxxbridge2$cxx_string$init(std::string *s, const std::uint8_t *ptr,
                                std::size_t len) noexcept {
  new (s) std::string(reinterpret_cast<const char *>(ptr), len);
}

void cxxbridge2$cxx_string$destroy(std::string *s) noexcept {
  using std::string;
  s->~string();
}

const char *cxxbridge2$cxx_string$data(const std::string &s) noexcept {
  return s.data();
}

std::size_t cxxbridge2$cxx_string$length(const std::string &s) noexcept {
  return s.length();
}

void cxxbridge2$cxx_string$clear(std::string &s) noexcept { s.clear(); }

void cxxbridge2$cxx_string$reserve_total(std::string &s,
                                         size_t new_cap) noexcept {
  s.reserve(new_cap);
}

void cxxbridge2$cxx_string$push(std::string &s, const std::uint8_t *ptr,
                                std::size_t len) noexcept {
  s.append(reinterpret_cast<const char *>(ptr), len);
}

// rust::String
void cxxbridge2$string$new(rust::String *self) noexcept;
void cxxbridge2$string$clone(rust::String *self,
                             const rust::String &other) noexcept;
bool cxxbridge2$string$from_utf8(rust::String *self, const char *ptr,
                                 std::size_t len) noexcept;
void cxxbridge2$string$from_utf8_lossy(rust::String *self, const char *ptr,
                                       std::size_t len) noexcept;
bool cxxbridge2$string$from_utf16(rust::String *self, const char16_t *ptr,
                                  std::size_t len) noexcept;
void cxxbridge2$string$from_utf16_lossy(rust::String *self, const char16_t *ptr,
                                        std::size_t len) noexcept;
void cxxbridge2$string$drop(rust::String *self) noexcept;
const char *cxxbridge2$string$ptr(const rust::String *self) noexcept;
std::size_t cxxbridge2$string$len(const rust::String *self) noexcept;
std::size_t cxxbridge2$string$capacity(const rust::String *self) noexcept;
void cxxbridge2$string$reserve_additional(rust::String *self,
                                          size_t additional) noexcept;
void cxxbridge2$string$reserve_total(rust::String *self,
                                     size_t new_cap) noexcept;

// rust::Str
void cxxbridge2$str$new(rust::Str *self) noexcept;
void cxxbridge2$str$ref(rust::Str *self, const rust::String *string) noexcept;
bool cxxbridge2$str$from(rust::Str *self, const char *ptr,
                         std::size_t len) noexcept;
const char *cxxbridge2$str$ptr(const rust::Str *self) noexcept;
std::size_t cxxbridge2$str$len(const rust::Str *self) noexcept;

// rust::Slice
void cxxbridge2$slice$new(void *self, const void *ptr,
                          std::size_t len) noexcept;
void *cxxbridge2$slice$ptr(const void *self) noexcept;
std::size_t cxxbridge2$slice$len(const void *self) noexcept;
} // extern "C"
...
String::String() noexcept { cxxbridge2$string$new(this); }

String::String(const String &other) noexcept {
  cxxbridge2$string$clone(this, other);
}

String::String(String &&other) noexcept : repr(other.repr) {
  cxxbridge2$string$new(&other);
}

String::~String() noexcept { cxxbridge2$string$drop(this); }

static void initString(String *self, const char *s, std::size_t len) {
  if (!cxxbridge2$string$from_utf8(self, s, len)) {
...
static void initString(String *self, const char16_t *s, std::size_t len) {
  if (!cxxbridge2$string$from_utf16(self, s, len)) {
...
const char *String::data() const noexcept {
  return cxxbridge2$string$ptr(this);
}

std::size_t String::size() const noexcept {
  return cxxbridge2$string$len(this);
}
...
const char *String::c_str() noexcept {
  ...
  cxxbridge2$string$reserve_additional(this, 1);
  auto ptr = this->data();
...
std::size_t String::capacity() const noexcept {
  return cxxbridge2$string$capacity(this);
}

void String::reserve(std::size_t new_cap) noexcept {
  cxxbridge2$string$reserve_total(this, new_cap);
}
...
Str::Str() noexcept { cxxbridge2$str$new(this); }

Str::Str(const String &s) noexcept { cxxbridge2$str$ref(this, &s); }

static void initStr(Str *self, const char *ptr, std::size_t len) {
  if (!cxxbridge2$str$from(self, ptr, len)) {
...
const char *Str::data() const noexcept { return cxxbridge2$str$ptr(this); }

std::size_t Str::size() const noexcept { return cxxbridge2$str$len(this); }
...
void sliceInit(void *self, const void *ptr, std::size_t len) noexcept {
  cxxbridge2$slice$new(self, ptr, len);
}

void *slicePtr(const void *self) noexcept { return cxxbridge2$slice$ptr(self); }

std::size_t sliceLen(const void *self) noexcept {
  return cxxbridge2$slice$len(self);
}
...
extern "C" {
const char *cxxbridge2$error(const char *ptr, std::size_t len) noexcept {
...
extern "C" {
repr::PtrLen cxxbridge2$exception(const char *, std::size_t len) noexcept;
}
...
void Fail::operator()(const char *catch$) noexcept {
  throw$ = cxxbridge2$exception(catch$, std::strlen(catch$));
}

void Fail::operator()(const std::string &catch$) noexcept {
  throw$ = cxxbridge2$exception(catch$.data(), catch$.length());
}
} // namespace detail
...
extern "C" {
void cxxbridge2$unique_ptr$std$string$null(
    std::unique_ptr<std::string> *ptr) noexcept {
  new (ptr) std::unique_ptr<std::string>();
}
void cxxbridge2$unique_ptr$std$string$raw(std::unique_ptr<std::string> *ptr,
                                          std::string *raw) noexcept {
  new (ptr) std::unique_ptr<std::string>(raw);
}
const std::string *cxxbridge2$unique_ptr$std$string$get(
    const std::unique_ptr<std::string> &ptr) noexcept {
  return ptr.get();
}
std::string *cxxbridge2$unique_ptr$std$string$release(
    std::unique_ptr<std::string> &ptr) noexcept {
  return ptr.release();
}
void cxxbridge2$unique_ptr$std$string$drop(
    std::unique_ptr<std::string> *ptr) noexcept {
  ptr->~unique_ptr();
}
} // extern "C"
...
#define STD_VECTOR_OPS(RUST_TYPE, CXX_TYPE)                                    \
  std::vector<CXX_TYPE> *cxxbridge2$std$vector$##RUST_TYPE##$new() noexcept {  \
    return new std::vector<CXX_TYPE>();                                        \
  }                                                                            \
  std::size_t cxxbridge2$std$vector$##RUST_TYPE##$size(                        \
      const std::vector<CXX_TYPE> &s) noexcept {                               \
    return s.size();                                                           \
  }                                                                            \
  CXX_TYPE *cxxbridge2$std$vector$##RUST_TYPE##$get_unchecked(                 \
      std::vector<CXX_TYPE> *s, std::size_t pos) noexcept {                    \
    return &(*s)[pos];                                                         \
  }                                                                            \
  void cxxbridge2$unique_ptr$std$vector$##RUST_TYPE##$null(                    \
      std::unique_ptr<std::vector<CXX_TYPE>> *ptr) noexcept {                  \
    new (ptr) std::unique_ptr<std::vector<CXX_TYPE>>();                        \
  }                                                                            \
  void cxxbridge2$unique_ptr$std$vector$##RUST_TYPE##$raw(                     \
      std::unique_ptr<std::vector<CXX_TYPE>> *ptr,                             \
      std::vector<CXX_TYPE> *raw) noexcept {                                   \
    new (ptr) std::unique_ptr<std::vector<CXX_TYPE>>(raw);                     \
  }                                                                            \
  const std::vector<CXX_TYPE>                                                  \
      *cxxbridge2$unique_ptr$std$vector$##RUST_TYPE##$get(                     \
          const std::unique_ptr<std::vector<CXX_TYPE>> &ptr) noexcept {        \
    return ptr.get();                                                          \
  }                                                                            \
  std::vector<CXX_TYPE>                                                        \
      *cxxbridge2$unique_ptr$std$vector$##RUST_TYPE##$release(                 \
          std::unique_ptr<std::vector<CXX_TYPE>> &ptr) noexcept {              \
    return ptr.release();                                                      \
  }                                                                            \
  void cxxbridge2$unique_ptr$std$vector$##RUST_TYPE##$drop(                    \
      std::unique_ptr<std::vector<CXX_TYPE>> *ptr) noexcept {                  \
    ptr->~unique_ptr();                                                        \
  }

#define STD_VECTOR_TRIVIAL_OPS(RUST_TYPE, CXX_TYPE)                            \
  void cxxbridge2$std$vector$##RUST_TYPE##$push_back(                          \
      std::vector<CXX_TYPE> *v, CXX_TYPE *value) noexcept {                    \
    v->push_back(std::move(*value));                                           \
    destroy(value);                                                            \
  }                                                                            \
  void cxxbridge2$std$vector$##RUST_TYPE##$pop_back(std::vector<CXX_TYPE> *v,  \
...
#define RUST_VEC_EXTERNS(RUST_TYPE, CXX_TYPE)                                  \
  void cxxbridge2$rust_vec$##RUST_TYPE##$new(                                  \
      rust::Vec<CXX_TYPE> *ptr) noexcept;                                      \
  void cxxbridge2$rust_vec$##RUST_TYPE##$drop(                                 \
      rust::Vec<CXX_TYPE> *ptr) noexcept;                                      \
  std::size_t cxxbridge2$rust_vec$##RUST_TYPE##$len(                           \
      const rust::Vec<CXX_TYPE> *ptr) noexcept;                                \
  std::size_t cxxbridge2$rust_vec$##RUST_TYPE##$capacity(                      \
      const rust::Vec<CXX_TYPE> *ptr) noexcept;                                \
  const CXX_TYPE *cxxbridge2$rust_vec$##RUST_TYPE##$data(                      \
      const rust::Vec<CXX_TYPE> *ptr) noexcept;                                \
  void cxxbridge2$rust_vec$##RUST_TYPE##$reserve_total(                        \
      rust::Vec<CXX_TYPE> *ptr, std::size_t new_cap) noexcept;                 \
  void cxxbridge2$rust_vec$##RUST_TYPE##$set_len(rust::Vec<CXX_TYPE> *ptr,     \
                                                 std::size_t len) noexcept;    \
  void cxxbridge2$rust_vec$##RUST_TYPE##$truncate(rust::Vec<CXX_TYPE> *ptr,    \
                                                  std::size_t len) noexcept;

#define RUST_VEC_OPS(RUST_TYPE, CXX_TYPE)                                      \
  template <>                                                                  \
  Vec<CXX_TYPE>::Vec() noexcept {                                              \
    cxxbridge2$rust_vec$##RUST_TYPE##$new(this);                               \
  }                                                                            \
  template <>                                                                  \
  void Vec<CXX_TYPE>::drop() noexcept {                                        \
    return cxxbridge2$rust_vec$##RUST_TYPE##$drop(this);                       \
  }                                                                            \
  template <>                                                                  \
  std::size_t Vec<CXX_TYPE>::size() const noexcept {                           \
    return cxxbridge2$rust_vec$##RUST_TYPE##$len(this);                        \
  }                                                                            \
  template <>                                                                  \
  std::size_t Vec<CXX_TYPE>::capacity() const noexcept {                       \
    return cxxbridge2$rust_vec$##RUST_TYPE##$capacity(this);                   \
  }                                                                            \
  template <>                                                                  \
  const CXX_TYPE *Vec<CXX_TYPE>::data() const noexcept {                       \
    return cxxbridge2$rust_vec$##RUST_TYPE##$data(this);                       \
  }                                                                            \
  template <>                                                                  \
  void Vec<CXX_TYPE>::reserve_total(std::size_t new_cap) noexcept {            \
    cxxbridge2$rust_vec$##RUST_TYPE##$reserve_total(this, new_cap);            \
  }                                                                            \
  template <>                                                                  \
  void Vec<CXX_TYPE>::set_len(std::size_t len) noexcept {                      \
    cxxbridge2$rust_vec$##RUST_TYPE##$set_len(this, len);                      \
  }                                                                            \
  template <>                                                                  \
  void Vec<CXX_TYPE>::truncate(std::size_t len) {                              \
    cxxbridge2$rust_vec$##RUST_TYPE##$truncate(this, len);                     \
  }
...
#define SHARED_PTR_OPS(RUST_TYPE, CXX_TYPE)                                    \
  ...
  void cxxbridge2$std$shared_ptr$##RUST_TYPE##$null(                           \
      std::shared_ptr<CXX_TYPE> *ptr) noexcept {                               \
    new (ptr) std::shared_ptr<CXX_TYPE>();                                     \
  }                                                                            \
  CXX_TYPE *cxxbridge2$std$shared_ptr$##RUST_TYPE##$uninit(                    \
      std::shared_ptr<CXX_TYPE> *ptr) noexcept {                               \
    CXX_TYPE *uninit =                                                         \
